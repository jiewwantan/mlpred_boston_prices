...
minikube kubectl -- create deployment mlpred-boston-prices --image=jiewwantan/mlrsbostonprices
...
minikube kubectl -- expose deployment/mlpred-boston-prices --type="NodePort" --port 8000
